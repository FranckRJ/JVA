    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        messageListAdapter.authorClickedListener = object : TopicAdapter.OnItemClickedListener {
            override fun onItemClicked(position: Int) {
                Toast.makeText(this@ViewTopicActivity, "Position d'auteur cliqué : " + position.toString(), Toast.LENGTH_SHORT).show()
            }
        }
        messageListAdapter.dateClickedListener = object : TopicAdapter.OnItemClickedListener {
            override fun onItemClicked(position: Int) {
                Toast.makeText(this@ViewTopicActivity, "Position de date cliquée : " + position.toString(), Toast.LENGTH_SHORT).show()
            }
        }
